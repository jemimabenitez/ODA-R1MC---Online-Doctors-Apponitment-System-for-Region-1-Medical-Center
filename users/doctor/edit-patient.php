...
{	
	$eid=$_GET['editid'];
	$patnameUp=$_POST['patname'];
	$patname=strtoupper($patnameUp);
	$patcontact=$_POST['patcontact'];
	$patemail=$_POST['patemail'];
	$genderUp=$_POST['gender'];
	$gender=strtoupper($genderUp);
	$pataddressUp=$_POST['pataddress'];
	$pataddress=strtoupper($pataddressUp);
	$patageUp=$_POST['patage'];
	$patage=strtoupper($patageUp);
	$medhisUp=$_POST['medhis'];
	$medhis=strtoupper($medhisUp);
