...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['msg']="Data succesfully deleted !!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
...
$sql=mysqli_query($con,"select * from doctorSpecilization order by id asc limit $limit offset $offset");
$cnt=1;
...
<?php
	...
	function create_page_link($page){

		$url="doctor-specialization.php?";
		$url2="";
...
?>
  ...
  <ul class="pagination">
  <li class="page-item">
      <a class="page-link" href="<?=create_page_link(1)?>">First</a>
    </li>

    <li class="page-item">
      <a class="page-link" href="<?=create_page_link(1)?>" >Prev</a>
    </li>

    <li class="page-item">
		<a class="page-link" href="<?=create_page_link(1)?>">1</a>
	</li>

    <li class="page-item active">
      <a class="page-link" href="<?=create_page_link(2)?>">2</a>
    </li>

    <li class="page-item"><a class="page-link" href="<?= create_page_link(3)?>">3</a></li>
    <li class="page-item">
