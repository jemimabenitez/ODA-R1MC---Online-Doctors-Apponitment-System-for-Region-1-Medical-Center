...
if(isset($_POST['submit']))
  {
    ...
    $bsUp=$_POST['bsUp'];
    $bs=strtoupper($bpUp);
    $weightUp=$_POST['weight'];
    $weight=strtoupper($weightUp);
    $tempUp=$_POST['temp'];
    $temp=strtoupper($tempUp);
    $presUp=$_POST['pres'];
    $pres=strtoupper($presUp);
...
<tr>
 ...
 <td><?php  echo $row['BloodSugar'];?></td> 
  ...
  <td><?php  echo $row['CreationDate'];?></td> 
  <td>
    <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit"></i></button> || <a href="manage-patient.php?id=<?php echo $row['ID']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
  </td>
