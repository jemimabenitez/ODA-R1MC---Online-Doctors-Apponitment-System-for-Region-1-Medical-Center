...
if(mysqli_num_rows($result) == 0) {
	...
	mysqli_query($con, "INSERT into admin(username,password) VALUES('".$username."','".$password."')") or die(mysqli_error()); 
			...
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					<form class="form-login" method="post">
						...
						<a href="users/doctor">Doctor Login</a><br>
						<a href="users/user-login.php">Patient Login</a>
