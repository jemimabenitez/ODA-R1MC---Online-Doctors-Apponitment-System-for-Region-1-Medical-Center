...
{
		$fullNameUp=$_POST['fullName'];
		$addressUp=$_POST['address'];
		$genderUp=$_POST['gender'];
		$email=$_POST['email'];
		
		$fullName=strtoupper($fullNameUp);
		$address=strtoupper($addressUp);
		$gender=strtoupper($genderUp);


		$sql=mysqli_query($con,"Update users set fullName='$fullName',address='$address',gender='$gender',email='$email' where id='$did'");
if($sql)
{
...
<hr />
													<form role="form" name="edit-user" method="post" onSubmit="return valid();">
