...
{	
	$fullNameUp=$_POST['fullName'];
		...
		$sql=mysqli_query($con,"Insert into users (fullName, address, gender, email, password) values ('$fullName', '$address', '$gender', '$email', '$password') ");
if($sql)
{
...
<div class="form-group">
					...
					<input type="text" name="fullName" class="form-control"  placeholder="Surname, Given name, M.I" required="true">
														</div>
...
<input type="email" id="docemail" name="email" class="form-control"  placeholder="Enter Doctor Email id" required="true" onBlur="checkemailAvailability()">
