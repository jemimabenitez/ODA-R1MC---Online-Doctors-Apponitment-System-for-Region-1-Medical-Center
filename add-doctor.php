...
{	
	...
	$docspecialization=strtoupper($specialization);
	...
	$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,contactno,docEmail,password) values('$docspecialization','$docname','$doccontactno','$docemail','$password')");
if($sql)
{
